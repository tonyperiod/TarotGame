...
public class CourtBuff : MonoBehaviour
{
    ...
    public void buff(GameObject court)
    {
        ...
        {
            if (court.GetComponent<CardScriptReference>().wlwm == manager.PRef.element)//compare player elem to this
            {
        ...
        {
            if (court.GetComponent<CardScriptReference>().wlwm == manager.ERef.element)
            {
    ...
    public void debuff(GameObject court)
    {
        ...
        if (court.GetComponent<CardScriptReference>().isplayer == true)
        {
            if (court.GetComponent<CardScriptReference>().wlwm == manager.PRef.element)
            {
                court.GetComponent<CardScriptReference>().value -= manager.elemBuff / 2; 
            }
        }
